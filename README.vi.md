...
Nó yêu cầu một mức improvement tối thiểu:

- Trong hotspot mode: dùng một ngưỡng sàn cố định.
- Ở các mode khác: ngưỡng tỷ lệ theo weighted MAD hiện tại.

Giá trị sàn tối thiểu mặc định:
